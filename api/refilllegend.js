...
export default async function handler(req, res) {
  ...
  try {
    ...
    const CONTRACT_ADDRESS = '0xd5aE0a7C8384Afb4D68319Cf63063e69b2960827';
    ...
    console.error('Refill Pool API Error:', err);
    ...
    res.status(500).json({
      error: 'Failed to execute refillPoolLegend',
